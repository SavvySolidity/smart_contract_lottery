...
// Iteractions script is created to test onchain automations on local vm chain ie. anvil
...
contract CreateSubscription is Script {
    ...
    function createSubscription(
        ...
        console.log ("Update HelperConfig with Subscription ID");
        return subId;
    }
...
contract FundSubsciption is Script {
